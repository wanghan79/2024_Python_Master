...
class UserInfoGenerator:
    ...
    def random_name(self):
        first_names = ["张", "李", "王", "刘", "赵", "孙", "周", "吴"]
        last_names = ["三", "四", "五", "六", "七", "八", "九", "十"]
        return random.choice(first_names) + random.choice(last_names)

    def random_email(self):
        domains = ["@example.com", "@mail.com", "@test.com", "@mydomain.com"]
...
class UserInfoGeneratorGUI:
    def __init__(self, generator):
        ...
        self.save_button = tk.Button(self.root, text="保存用户信息", command=self.save_users)
    ...
    def generate_users(self):
        ...
        try:
            ...
            messagebox.showinfo("成功", "成功生成了用户信息。")
    ...
    def save_users(self):
        try:
            ...
            messagebox.showinfo("成功", "成功保存了用户信息。")
